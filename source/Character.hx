...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'piano':
				tex = Paths.getSparrowAtlas('pianoAssets','shared',true);
				frames = tex;
				animation.addByPrefix('idle', 'Piano Idle', 24, false);
				animation.addByPrefix('singUP', 'Piano Up', 24, false);
				animation.addByPrefix('singRIGHT', 'Piano Right', 24, false);
				animation.addByPrefix('singDOWN', 'Piano Down', 24, false);
				animation.addByPrefix('singLEFT', 'Piano Left', 24, false);
